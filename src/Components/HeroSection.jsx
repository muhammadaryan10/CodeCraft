...
export default function HeroSection() {
    return (
        <div>
            ...
            <section
                className="relative bg-top  shadow bg-no-repeat"
            ...
            >
                ...
                <div
                    className="relative mx-auto max-w-screen-4xl px-4 py-24 sm:px-6 lg:flex lg:h-screen  lg:px-8"
                >
                    <div className="max-w-4xl text-start ltr:sm:text-left rtl:sm:text-right">
                        <h1 className="text-3xl font-extrabold sm:text-5xl text-white py-2">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4 text-center">
                            <img
                                ...
                                className="block rounded  text-sm font-medium text-white h-16"
                            />
                            <img
                                src='https://expertcodecraft.com/wp-content/uploads/2023/09/trustpilot.webp'
                                className="block rounded  text-sm font-medium sm:w-auto h-16"
                            />
