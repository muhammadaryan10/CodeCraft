...
export default function LogoPackages() {
    return (
        <div>
            <Swiper
                effect={'coverflow'}
            ...
            >
                <SwiperSlide>
                    <div className="p-6 h-[80vh] testonomical_background flex flex-col justify-center items-center">
                        ...
                        <button href="#" className="w-100 theme_color  p-3 my-8 text-sm transition duration-300 hover:scale-105 font-medium text-white shadow hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 sm:w-auto">
