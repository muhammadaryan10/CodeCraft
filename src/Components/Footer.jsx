        ...
        <footer className="text-white testonomical_background px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            ...
            <div className="mt-8 pt-6 border-t items-center justify-between sm:flex" >
                <div className="mt-4 sm:mt-0">
                    &copy;2024 Expert Code Craft. All Rights Reserved.
                </div>
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        <li className="w-10 h-10 border rounded-full flex items-center theme_background justify-center">
                            <a href="javascript:void()">
                                <svg class="svg-icon w-6  h-6 theme_text" viewBox="0 0 20 20">
